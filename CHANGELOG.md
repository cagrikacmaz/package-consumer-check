...
- Resolve npm-created Unix binary symlinks when detecting direct CLI invocation
- Keep text files LF-normalized on Windows checkouts so formatting checks remain platform-stable
